...
int FlashRequestJson_setDmaKtOutputRef ( struct PortalInternal *p, const uint32_t sgIdKtBuf0, const uint32_t sgIdKtBuf1, const uint32_t sgIdKtBuf2, const uint32_t sgIdKtBuf3, const uint32_t sgIdInvalPPA )
{
    Json::Value request;
    request.append(Json::Value("setDmaKtOutputRef"));
    request.append((Json::UInt64)sgIdKtBuf0);
    request.append((Json::UInt64)sgIdKtBuf1);
    request.append((Json::UInt64)sgIdKtBuf2);
    request.append((Json::UInt64)sgIdKtBuf3);
