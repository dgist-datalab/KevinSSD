...
typedef struct {
    ...
    int (*setDmaKtOutputRef) (  struct PortalInternal *p, const uint32_t sgIdKtBuf0, const uint32_t sgIdKtBuf1, const uint32_t sgIdKtBuf2, const uint32_t sgIdKtBuf3, const uint32_t sgIdInvalPPA );
