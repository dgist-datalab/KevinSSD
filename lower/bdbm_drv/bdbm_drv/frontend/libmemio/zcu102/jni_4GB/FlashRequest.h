...
public:
    ...
    int setDmaKtOutputRef ( const uint32_t sgIdKtBuf0, const uint32_t sgIdKtBuf1, const uint32_t sgIdKtBuf2, const uint32_t sgIdKtBuf3, const uint32_t sgIdInvalPPA ) { return cb->setDmaKtOutputRef (&pint, sgIdKtBuf0, sgIdKtBuf1, sgIdKtBuf2, sgIdKtBuf3, sgIdInvalPPA); };
...
public:
    ...
    virtual void setDmaKtOutputRef ( const uint32_t sgIdKtBuf0, const uint32_t sgIdKtBuf1, const uint32_t sgIdKtBuf2, const uint32_t sgIdKtBuf3, const uint32_t sgIdInvalPPA ) = 0;
