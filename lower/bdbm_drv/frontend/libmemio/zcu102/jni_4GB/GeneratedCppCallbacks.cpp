...
int FlashRequestsetDmaKtOutputRef_cb (  struct PortalInternal *p, const uint32_t sgIdKtBuf0, const uint32_t sgIdKtBuf1, const uint32_t sgIdKtBuf2, const uint32_t sgIdKtBuf3, const uint32_t sgIdInvalPPA ) {
    (static_cast<FlashRequestWrapper *>(p->parent))->setDmaKtOutputRef ( sgIdKtBuf0, sgIdKtBuf1, sgIdKtBuf2, sgIdKtBuf3, sgIdInvalPPA);
    return 0;
};
