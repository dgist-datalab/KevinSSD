...
int main(int argc,char* argv[]){
	...
	//bench_add(RANDRW,0,(INPUTREQNUM?INPUTREQNUM:SHOWINGFULL)/1,((INPUTREQNUM?INPUTREQNUM:SHOWINGFULL))/1*4);
	/ench_add(FILLRAND,0,(INPUTREQNUM?INPUTREQNUM:SHOWINGFULL)/1,((INPUTREQNUM?INPUTREQNUM:SHOWINGFULL)));
	bench_add(RANDGET,0,(INPUTREQNUM?INPUTREQNUM:SHOWINGFULL)/1,(INPUTREQNUM?INPUTREQNUM:SHOWINGFULL)/1);
